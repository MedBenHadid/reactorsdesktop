...
public class DomainesController implements Initializable {
    @FXML private TableView<Category> catTV;
    @FXML private TableColumn<Category, Category> deleteOption;
    @FXML private TableColumn<Category, String> nomCol, descCol;
    @FXML private TableColumn<Category, Number> idCol;
    @FXML private TextArea description;
    @FXML private TextField input, nom;
